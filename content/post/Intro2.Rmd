...
El insumo principal  para su elaboración es el agua, (el agua representa el 95% de este producto). Una forma comumenete aceptada para medir la intensidad en el uso de los recursos hídricos de un producto,  es a través del concepto de la huella hídirca (HH).

Se estima que la producción de un litro de cerveza implica una huella hídrica de **300** litros,[@mekonnen_green_2011] por lo que, el impacto de la cadena de valor desde el punto de vista de los recursos hídricos es considerable. 
