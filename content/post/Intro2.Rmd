...
Si bien, estudios especializados sobre Huella hídrica (HH), estiman que  para producir un litro de cervezala, la  **Cebeda**, genera una HH de **298** litros^[A diferencia del **impacto ambiental**[@@mekonnen_green_2011], este cifra no es un estimado aplicable a escala goblal, ya que existe una gran variabilidad asociada a las condiciones productivas regionales. 

Sin ambargo, es importante notar que el impacto de la huella hidrica de la producción de insumos  como la **Cebada**, no necesariamente recae directamente en la región donde se ubica la planta productora, pero recae en la región agrícola que produce la Cebada, (en el caso de México, Guanajuato es la principal entidad  productora de Cebada generando 1 de cada 3 toneladas que se producen en México o 36.8 % de la producción total nacional, [@INEGI])]. 
