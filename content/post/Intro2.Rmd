...
Se estima que su producción involucra una cadena de valor cuya integración esta distribuida a lo largo  **168 actividades económicas**[@INEGI].  


El insumo principal  para su elaboración es el agua, (el agua representa el 95% de este producto y el impacto de la cadena de valor desde el punto de vista de los recursos hídricos es considerable. 

No obstante, en México el costo de este insumo representa sólo el **0.8%** del valor de total de los insumos empleados para su producción[@INEGI]. 
...
Acorde con Mekonnen (2011), la producción de un litro de cerveza implica una huella hídrica de **300** litros de agua. (Unicamente  la Cebeda necesaria para producir un litro de cerveza, tiene una huella hidrica de **298** litros^[A diferencia del **impacto ambiental** por el uso de recursos hídricos en la producción de la **cerveza**, el impacto de la huella hidrica de la producción de insumos como la **Cebada**, no necesariamente recae directamente en la región donde se ubica la planta productora, pero recae en la región agricola que produce la Cebada, (en el caso de México, GUanajuato es la principal entidad  productora de Cebada generando 1 de cada 3 toneladas que se producen en México o 36.8 % de la producción total nacional, [@INEGI])]. 
Acorde con el Instituto Mexicano de Tecnología del Agua, la producción de Cebada tiene una huella hídrica de  49 metros cubicos/ ton.[@hh]  Por lo que al considerar la producción de Cebada en grano reportada por el Sistema de Información Agroalimentaria de Consulta en México para 2020[@siacon], (864,293.27 ton.), es posible estimar que se tuvo una HH de  42.3 millones de metros cúbicos de agua (subterránea y superficial)) [@mekonnen_green_2011]. 
