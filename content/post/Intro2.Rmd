...
El insumo principal  para su elaboración es el agua, (el agua representa el 95% de este producto y el impacto de la cadena de valor desde el punto de vista de los recursos hídricos es considerable, ya que la producción de un litro de cerveza implica una huella hídrica de **300** litros de agua.[@mekonnen_green_2011]

No obstante, en México el costo de este insumo representa sólo el **0.8%** del costo total de los insumos necesarios para su producción[@INEGI]. 
