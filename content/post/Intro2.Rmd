...
El insumo principal  para su elaboración es el agua, (el agua representa el 95% de este producto),  la producción de un litro de cerveza implica una huella hídrica de **300** litros de gua.[@mekonnen_green_2011] y el impacto de la cadena de valor desde el punto de vista de los recursos hídricos es considerable. 
...
La grafica 1 muestra el contraste de los costos de agua para uso dómestico,  (proxi de la tarifas para uso industrial) en un conjunto de 15 ciudades en el mundo.
...
**Tarifas de agua para uso industrial. Principales 40 ciudades según costo, 2020**
...
De manera complementaria la produción de **Insumos agrícolas** fundamentales como la **Cebada** y el **Lúpulo**,  añaden a la **huella hídrica** que genera la producción de la cerveza. 
...
Por lo que al considerar la producción de Cebada en grano reportada por el Sistema de Información Agroalimentaria de Consulta en México para 2020, que fue de 864,293.27 ton.)[@siacon], se observa una HH de  42.3 millones de metros cúbicos de agua (subterránea y superficial)) [@mekonnen_green_2011]. 
...
el proceso implica una demanda directa de recursos hídricos en la región de **2,100 millones de litros** anuales.  
...
Por otra parte desde la perspectiva de impacto amabiental, la planta genera una huella hídrica que alcanza los **180 000 000 000** litros anuales. 
