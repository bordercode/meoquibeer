...
Se estima que su producción involucra una integración distribuida a lo largo  **168 actividades económicas**.  No obstante, el impacto de la **cadena de valor** desde el punto de vista de los recursos hídricos es considerable. 

El insumo principal  para su elaboración es el agua, (el agua representa el 95% de este producto, paradójicamente, el valor de este insumo muy barato, ya que representa sólo el 0.8% del valor de total de los insumos empleados para su producción. [@INEGI]. Otros **insumos agrícolas** fundamentales como la **Cebada** y el **Lúpulo**,  añaden a la **huella hídrica** que genera la producción de la cerveza. 
...
Considernado que la planta  **Heineken de Meoquí** produce  **600 millones de litros** anualmente [@heineken], la demanda de **agua** de esta cervecera de origen holandés, en la región Meoqui, alcanza los **180 000 000** metros cúbicos. Importante puntualizar que la huella hidrica atribuible a la producción de cebada se genera en el sitio en donde este se produce^[A diferencia del **impacto ambiental** por el uso de recursos hídricos en la producción de la **cerveza**, el impacto de la huella hidrica de la producción de insumos como la **Cebada**, no necesariamente recae directamente en la región donde se ubica la planta productora, pero recae en la región agricola que produce la Cebada, (en el caso de México, GUanajuato es la principal entidad  productora de cebada generando 1 de cada 3 toneladas que se producen en México  36.8 % [@INEGI]) esta puede ubicarse en un sitio totalmente distinto]. 
