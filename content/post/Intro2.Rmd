...
Acorde con Mekonnen (2011), la producción de un litro de cerveza implica una huella hídrica de **300** litros de agua. (Unicamente  la Cebeda necesaria para producir un litro de cerveza, tiene una huella hidrica de **298** litros^[A diferencia del **impacto ambiental** por el uso de recursos hídricos en la producción de la **cerveza**, el impacto de la huella hidrica de la producción de insumos como la **Cebada**, no necesariamente recae directamente en la región donde se ubica la planta productora, pero recae en la región agricola que produce la Cebada, (en el caso de México, GUanajuato es la principal entidad  productora de Cebada generando 1 de cada 3 toneladas que se producen en México o 36.8 % de la producción total nacional, [@INEGI])]. ) [@mekonnen_green_2011]. 


Considerando que la planta  **Heineken de Meoquí** produce  **600 millones de litros** anualmente, [@eluyde_heineken_2018]
